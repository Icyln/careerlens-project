...
class AnalysisReportViewSet(viewsets.ModelViewSet):
    ...
    def dashboard(self, request):
        ...
        use_ai = str(request.query_params.get('ai', 'false')).lower() in {'1', 'true', 'yes'}
        metrics['career_guidance'] = generate_dashboard_guidance(metrics, use_ai=use_ai)
